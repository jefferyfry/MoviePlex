...
-(NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *momURL = [[NSBundle mainBundle] URLForResource:@"MoviePlex" withExtension:@"momd"];
...
- (NSURL *)applicationDocumentsDirectory
{
    ...
    return [[documentDirectory URLByAppendingPathComponent:@"MoviePlex"] URLByAppendingPathExtension:@"sqlite"];
}
